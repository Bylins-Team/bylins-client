...
- Установщики msi и deb собираются без плагинов (DMG — с ними: на macOS он
  строится из образа); комплект для раздачи делает `releaseDist`
- Сборка для macOS не подписана — скачанное приложение попадает в карантин
